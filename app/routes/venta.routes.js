...
router.get(`/${path}/:busca`, obtenerUnaVenta);
...
router.post(
  ...
  [
    ...
    check(
      "id_cliente",
      "La identificación del cliente debe tener al menos 6 caracteres."
    ).isLength({ min: 6 }),
    ...
    check("productos", "La venta debe tener una lista de productos.")
      .not()
      .isEmpty(),
    validarCampos,
  ],
